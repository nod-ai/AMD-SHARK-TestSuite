...
constructor0 = get_sibling_constructor(
    ImageClassificationModel, AzureDownloadableModel, "resnet50_vaiq_int8"
)
constructor1 = get_sibling_constructor(
    ImageClassificationModel, AzureDownloadableModel, "ResNet50_vaiq"
)
...
constructor2 = get_sibling_constructor(
    NoOptimizations, AzureDownloadableModel, "resnet50_vaiq_int8"
)
constructor3 = get_sibling_constructor(
    NoOptimizations, AzureDownloadableModel, "ResNet50_vaiq"
)
